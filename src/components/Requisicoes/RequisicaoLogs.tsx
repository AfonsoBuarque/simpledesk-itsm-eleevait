...
interface RequisicaoLogsProps {
  requisicao: Solicitacao;
}

export const RequisicaoLogs: React.FC<RequisicaoLogsProps> = ({ requisicao }) => {
  const { logs, isLoading, error } = useRequisicaoLogs(requisicao.id);
  return (
