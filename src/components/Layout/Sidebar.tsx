  ...
  return (
    <>
      ...
      <aside className={cn(
        ...
        "lg:relative lg:translate-x-0 shadow-xl lg:h-screen",
        isOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0",
        isCollapsed ? "w-16 min-w-16" : "w-64 min-w-64 max-w-80"
      )}>
        <div className={cn("p-4 h-full min-h-screen flex flex-col overflow-hidden bg-gradient-to-b from-gray-900 to-gray-800", isCollapsed && "px-2")}>
          <div className="mb-6">
